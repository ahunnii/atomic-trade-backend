...
export const ContactPageForm = ({ initialData, storeSlug, storeId }: Props) => {
  ...
  const form = useForm<ReservedPageFormData>({
    ...
    defaultValues: {
      contactPage: initialData?.contactPage ?? null,
      enableContactPage: initialData?.enableContactPage ?? false,
    },
  });
  ...
  const onSubmit = async (data: ReservedPageFormData) => {
    ...
    updatePoliciesMutation.mutate({
      ...data,
      storeId,
      contactPage: form.getValues("contactPage") as JsonValue,
      enableContactPage: form.getValues("enableContactPage") ?? false,
    });
  };
  ...
  return (
    <>
      <Form {...form}>
        ...
        >
          <FormHeader title={"Update Contact Page"} link={parentPath}>
            <FormDiscardButton
              isLoading={isLoading}
              redirectPath={parentPath}
            />
          ...
          <section className="form-body">
            <div className="col-span-12 flex w-full flex-col space-y-4 xl:col-span-9">
              <div className="form-card">
                <LargeMarkdownFormField
                  form={form}
                  ref={editorRef}
                  contentFieldName="contactPage"
                  label="Contact Page Content"
                  description="The content of the contact page. This is the main content of the page. It is the text that will be displayed on the page."
            ...
            <div className="col-span-12 flex w-full flex-col space-y-4 xl:col-span-3">
              <div className="form-card sticky top-20">
                <SwitchFormField
                  form={form}
                  name="enableContactPage"
                  description="Enable or disable the contact page."
