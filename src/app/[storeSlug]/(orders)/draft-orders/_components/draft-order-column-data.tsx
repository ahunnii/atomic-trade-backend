...
export const draftOrderColumnData: ColumnDef<DraftOrderColumn>[] = [
  {
      ...
      return (
        <div className="flex flex-col">
          <PrimaryCellLink
            ...
            link={`/${row.original.storeSlug}/customers/${row.original.customer.id}/edit`}
          />
        </div>
      );
    },
