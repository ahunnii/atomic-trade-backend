...
export const PrivacyPolicyForm = ({
  ...
  const title = "Update Privacy Policy";
  ...
  const onSubmit = async (data: PoliciesFormData) => {
    ...
    updatePoliciesMutation.mutate({
      ...data,
      storeId,
      privacyPolicy: form.getValues("privacyPolicy") as JsonValue,
    });
  };
          ...
          <section className="form-body">
            <div className="col-span-12 flex w-full flex-col space-y-4 xl:col-span-7">
              <FormSection
                ...
                description="Set up your store's privacy policy."
                bodyClassName="space-y-4"
              >
                <LargeMarkdownFormField
                  form={form}
                  ref={editorRef}
                  contentFieldName="privacyPolicy"
