...
export function TestOrderDiscounts({ orders, storeId }: Props) {
            ...
            {selectedOrder && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Compare how order data will be transformed for Stripe
                    checkout
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <ul className="list-disc space-y-1 pl-5">
                        <li>
                          Variant data is fetched from database including
                          product info
                        </li>
                        <li>
                          Stock availability is checked if stock is managed
                        </li>
                        <li>
                          ...
                          <ul className="mt-1 list-disc pl-5">
                            ...
                            <li>
                              Unit amount from compareAtPriceInCents or
                              priceInCents
                            </li>
